...
#
# Script generated by Vivado on Tue Jun 17 12:35:49 CEST 2025
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 8 -d "TARGET_FPGA=" -d "TARGET_RTL=" -d "TARGET_SYNTHESIS=" -d "TARGET_VIVADO=" -d "TARGET_XILINX="  -L xil_defaultlib -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot clk_wiz_0 xil_defaultlib.clk_wiz_0 xil_defaultlib.glbl -log elaborate.log
}
...
copy_setup_file()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="/usr/pack/vitis-2023.2-zr/Vivado/2023.2/data/xsim"
  fi
