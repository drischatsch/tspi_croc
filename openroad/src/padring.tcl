...
place_pad -row IO_NORTH  -location [expr $start -  2*$pitch] "pad_gpio20_io"       ; # pin no:  3
place_pad -row IO_NORTH  -location [expr $start -  3*$pitch] "pad_gpio21_io"       ; # pin no:  4
place_pad -row IO_NORTH  -location [expr $start -  4*$pitch] "pad_gpio22_io"       ; # pin no:  5
place_pad -row IO_NORTH  -location [expr $start -  5*$pitch] "pad_gpio23_io"       ; # pin no:  6
place_pad -row IO_NORTH  -location [expr $start -  6*$pitch] "pad_gpio24_io"       ; # pin no:  7
place_pad -row IO_NORTH  -location [expr $start -  7*$pitch] "pad_gpio25_io"       ; # pin no:  8
place_pad -row IO_NORTH  -location [expr $start -  8*$pitch] "pad_gpio26_io"       ; # pin no:  9
place_pad -row IO_NORTH  -location [expr $start -  9*$pitch] "pad_gpio27_io"       ; # pin no: 10
place_pad -row IO_NORTH  -location [expr $start - 10*$pitch] "pad_gpio28_io"       ; # pin no: 11
place_pad -row IO_NORTH  -location [expr $start - 11*$pitch] "pad_gpio29_io"       ; # pin no: 12
place_pad -row IO_NORTH  -location [expr $start - 12*$pitch] "pad_gpio30_io"       ; # pin no: 13
place_pad -row IO_NORTH  -location [expr $start - 13*$pitch] "pad_gpio31_io"       ; # pin no: 14
