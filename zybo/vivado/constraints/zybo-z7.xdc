...
# Pmod Header JA (XADC)
# --------------------------------------------------------------------------------------------------
#set_property -dict { PACKAGE_PIN N15  IOSTANDARD LVCMOS33 }     [get_ports { tspi_cs_no }];          #IO_L21P_T3_DQS_AD14P_35    Sch=JA1_R_p
#set_property -dict { PACKAGE_PIN L14  IOSTANDARD LVCMOS33 }     [get_ports { tspi_mosi_o }];          #IO_L22P_T3_AD7P_35         Sch=JA2_R_P
#set_property -dict { PACKAGE_PIN K16  IOSTANDARD LVCMOS33 }     [get_ports { tspi_miso_i }];          #IO_L24P_T3_AD15P_35        Sch=JA3_R_P
#set_property -dict { PACKAGE_PIN K14  IOSTANDARD LVCMOS33 }     [get_ports { tspi_clk_o }];          #IO_L20P_T3_AD6P_35         Sch=JA4_R_P
