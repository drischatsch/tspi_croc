...
compile()
{
  vlogan -work xpm $vlogan_opts -sverilog +define+TARGET_FPGA= +define+TARGET_RTL= +define+TARGET_SYNTHESIS= +define+TARGET_VIVADO= +define+TARGET_XILINX= +incdir+"../../../ipstatic" \
  ...
  vlogan -work xil_defaultlib $vlogan_opts +v2k +define+TARGET_FPGA= +define+TARGET_RTL= +define+TARGET_SYNTHESIS= +define+TARGET_VIVADO= +define+TARGET_XILINX= +incdir+"../../../ipstatic" \
