...
place_pad -row IO_NORTH  -location [expr $start - 10*$pitch] "pad_tspi_clk_o"      ; # pin no: 11
place_pad -row IO_NORTH  -location [expr $start - 11*$pitch] "pad_tspi_mosi_o"     ; # pin no: 12
place_pad -row IO_NORTH  -location [expr $start - 12*$pitch] "pad_tspi_miso_i"     ; # pin no: 13
place_pad -row IO_NORTH  -location [expr $start - 13*$pitch] "pad_tspi_cs_no"      ; # pin no: 14
