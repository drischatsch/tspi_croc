...
# yosys setattr -set keep_hierarchy 1 "t:req_blocker$*"
yosys setattr -set keep_hierarchy 1 "t:block_swap_config$*"
yosys setattr -set keep_hierarchy 1 "t:block_swap_ctrl$*"
yosys setattr -set keep_hierarchy 1 "t:obi_cut$*"
